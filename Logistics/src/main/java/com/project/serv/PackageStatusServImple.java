...
import com.project.dao.PackageStatusDao;
import com.project.model.Package;
import com.project.model.PackageStatus;

@Service
public class PackageStatusServImple implements PackageStatusServ {
	@Autowired
	...
	public boolean status(PackageStatus pkg) {
		...
		return packagestatusdao.status(pkg);
	}

	@Override
	public Iterable<PackageStatus> findAll() {
		// TODO Auto-generated method stub
		return packagestatusdao.findAll();
	}

	@Override
	public boolean create(PackageStatus pkg) {
		
		return packagestatusdao.create(pkg);
	}

	@Override
	public boolean changeStatus(PackageStatus pkg) {
		// TODO Auto-generated method stub
		return packagestatusdao.changeStatus(pkg);
	}

	@Override
	public boolean create2(PackageStatus pkg) {
		// TODO Auto-generated method stub
		return packagestatusdao.create2(pkg);
	}

	@Override
	public Iterable<PackageStatus> findAll1() {
		// TODO Auto-generated method stub
		return packagestatusdao.findAll1();
	}
}
