...
<script async defer
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoB-BsEvPcyikw7T2AudyFfOpQknFLbGI&callback=myMap"></script>
</head>
<body>
	...
	<input type="hidden" name="vehicleId" value="${vehicleId}"
		class="form-control" id="vno" readonly>
