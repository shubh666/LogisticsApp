...
<body>
	...
	<div class="tbl-content">
		<table cellpadding="0" cellspacing="0" border="0">
			<tbody>
				...
				<c:forEach var="packageStatus" items="${listPackageStatus}"
					varStatus="status">
					<tr>
						...
						<td>
							<form method="post" action="location">
								<input type="hidden" name="vehicleId"
									value="${packageStatus.vehicleId}"> <input
									class="button" type="submit" value="location">
							</form>
						</td>
						<td>
							<form method="post" action="delivered">
								<input type="hidden" name="packageId"
									value="${packageStatus.packageId}"> <input
									type="hidden" name="vehicleId"
									value="${packageStatus.vehicleId}"> <input
									type="hidden" name="employeeId"
									value="${packageStatus.employeeId}"> <input
									class="button" type="submit" value="delivered">
							</form>
						</td>
					</tr>
				</c:forEach>
	...
	<div
		...
		<a href="home"><button class="button" style="border: 1cm;">
				<span>Back</span>
			</button></a>
	</div>
