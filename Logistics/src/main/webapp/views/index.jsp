...
<script>
	function InvalidMsg(textbox) {
		...
		if (textbox.value === '') {
			...
			textbox
					.setCustomValidity('Please enter an user id which is valid!');
		} else {
	...
	function InvalidPass(textbox) {
		...
		if (textbox.value === '') {
			textbox.setCustomValidity('without password you can not enter');
		} else if (textbox.validity.typeMismatch) {
			textbox.setCustomValidity('Please enter password which is valid!');
		} else {
			textbox.setCustomValidity('');
		}
	...
	<div class="login">
		...
		<form action="/" method="post" name="myform">
			...
			<input id="email" oninvalid="InvalidPass(this);"
				oninput="InvalidPass(this);" placeholder="password"
				name="userPassword" type="password" required="required" />

			<button type="submit" class="btn btn-primary btn-block btn-large"
				onclick="validateform()">Let me in.</button>
			<a href="forgetPassword">forget Password?</a> <br> <a
				href="register"><input type="button" value="Register"
