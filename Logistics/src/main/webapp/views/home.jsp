...
<body>
  ...
  <ul>
    ...
    <a href="logout">logout</a>
		...
		<div>	<a href="vehicle"><button style="margin-left: 10cm" class="button"><span>Vehicle </span></button></a>
			
			<a href="employee"><button class="button"><span>Employee </span></button></a></div>
			<br>
			<div>
			<a href="package"><button style="margin-left: 10cm" class="button"><span>Package </span></button></a>
			
			<a href="status"><button class="button"><span>Status </span></button></a>
		</div>
		<br>
		<div>
			<a href="delivered"><button style="margin-left: 10cm" class="button"><span>Delivered</span></button></a>
			<a href="history"><button class="button"><span>History</span></button></a>
			</div>
